...
export default function ModuleContactCTA() {
  return (
    <section className="py-12 md:py-16 lg:py-18 bg-brand-neutral font-sans px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto relative overflow-hidden rounded-[2rem] bg-brand-dark shadow-2xl">
        ...
        <div className="relative z-10 p-10 md:p-16 flex flex-col items-start">
          ...
          <p className="text-base md:text-lg text-white/70 mb-6 md:mb-10 max-w-xl">
            Telefonla veya e-posta ile bize ulaşın. Ekibimiz size yardımcı olsun.
          </p>

          <div className="flex flex-col space-y-2 mb-6 md:mb-10">
          ...
          <Link
            href="/contact"
            className="inline-flex bg-gradient-to-r from-blue-600 to-[#00b4d8] hover:from-blue-500 hover:to-[#00d4ff] text-white font-semibold text-base md:text-lg py-4 px-6 md:px-10 rounded-full transition-all duration-300 shadow-[0_0_20px_rgba(0,180,216,0.4)] hover:shadow-[0_0_30px_rgba(0,180,216,0.6)]"
          >
            İletişim
          </Link>
        </div>
