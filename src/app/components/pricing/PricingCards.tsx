    ...
    <section className="py-12 bg-brand-neutral font-sans ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          {/* Sol Kart (Aylık) */}
          <div className="bg-white rounded-[2rem] p-8 lg:p-10 shadow-lg border border-black/[0.04] flex flex-col">
            <h3 className="text-2xl font-bold text-brand-dark mb-2">Aylık Ödeme</h3>
            <p className="text-brand-text mb-6">Tek Şubeli Merkezler</p>
            ...
            <ul className="space-y-4 mb-10 flex-1">
              {FEATURES.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-3 text-brand-dark/80 font-medium">
          ...
          <div className="bg-gradient-to-br from-brand-dark via-[#1a2642] to-brand-blue rounded-[2rem] p-8 lg:p-10 shadow-2xl relative overflow-hidden flex flex-col transform md:-translate-y-4">
            ...
            <div className="relative z-10 flex flex-col h-full">
              <h3 className="text-2xl font-bold text-white mb-2">Yıllık Ödeme <span className="font-medium">(Avantajlı)</span></h3>
              <p className="text-white/80 mb-6">Yıllık peşin ödeme</p>
          ...
          {/* Sağ Kart (Özel Fiyat) */}
          <div className="bg-white rounded-[2rem] p-8 lg:p-10 shadow-lg border border-black/[0.04] flex flex-col">
            <h3 className="text-2xl font-bold text-brand-dark mb-2 leading-tight">Özel Fiyat için <br/> İletişime Geçin</h3>
            <p className="text-brand-text mb-6">Birden Fazla Şubesi Olan Merkezler</p>
            {/* Özel fiyat kartında sabit fiyat alanı boş bırakıldığı için boşluk (spacer) bırakıyoruz */}
            <div className="h-[4.5rem] mb-8"></div>
