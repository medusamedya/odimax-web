      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-4 md:mb-8 flex flex-col items-center">
          ...
          <h2 className="font-sans text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wide pb-1 leading-[1.15] inline-block bg-gradient-to-r from-brand-header-text from-60% to-[#595A5B] bg-clip-text text-transparent">
            İşitme Merkeziniz İçin Net Bir
            <br className="hidden md:block" />
            Yönetim Planı
          </h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 md:gap-16 lg:gap-20 items-center">
          {/* Sol Kısım: Açıklama Paragrafları */}
          <div className="flex flex-col space-y-3 md:space-y-6">
            <div className="text-lg text-brand-text leading-relaxed space-y-6">
              <p>
                Odimax; hasta, randevu, stok, tahsilat, satış ve ÜTS
                süreçlerinizi tek panelde daha düzenli yönetmeniz için
                geliştirilmiş sektörel bir yönetim sistemidir.
              </p>
              <p>
                Yalnızca yazılım kullanmaya başlamazsınız; merkezinizin temel iş
                akışlarını Odimax düzenine taşımak için başlangıç desteği
                alırsınız.
              </p>
              <p className="text-brand-text">
                Planınızı seçin, merkezinizin günlük operasyonunu birlikte daha
                kontrollü hale getirelim.
              </p>
            </div>
          </div>
